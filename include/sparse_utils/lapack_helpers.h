...
// // alpha*A**T*A + beta*C
// inline void BLASsyrk(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO
// Uplo,
...
// inline void BLAStpsv(const enum CBLAS_ORDER order, const enum CBLAS_UPLO
// Uplo,
//                      const enum CBLAS_TRANSPOSE TransA,
//                      const enum CBLAS_DIAG Diag, int n, std::complex<double>
//                      *a, std::complex<double> *x, int incx) {
...
//   *info = LAPACKE_zgetri_work(LAPACK_COL_MAJOR, n, a, lda, ipiv, work,
//   lwork);
// }
